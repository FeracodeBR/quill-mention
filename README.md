...
| `renderItemTemplate(el, item, searchTerm, mentionChar)`      | `undefined`                                            | A function that gives you control to list item element. You can use this function to highlight the search term or change the design with custom HTML.                                                                                                                                                                                                                                                                                                         |
